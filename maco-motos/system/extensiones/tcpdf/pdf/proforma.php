...
public function traerProforma(){

//TRAER INFORMACION DE LA PROFORMA
$itemProform = "codigo";
$valorProform = $this->codigo;
$respuestaVenta = ControladorProformas::ctrMostrarProformas($itemProform, $valorProform);
//===============================================================================================
...
$proform = new ImprimirProforma();
$proform -> codigo = $_GET["codigo"];
$proform -> traerProforma();
