...
class ImprimirCotizacionVenta{

public $codigo;

public function traerCotizacionVenta(){
...
//SALIDA ARCHIVO
$pdf->Output('cotizacionVenta.pdf');
}

}

$proform = new ImprimirCotizacionVenta();
$proform -> codigo = $_GET["codigo"];
$proform -> traerCotizacionVenta();
