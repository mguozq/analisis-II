...
class ImprimirProformaVenta{

public $codigo;

public function traerProformaVenta(){
...
$totalALetras = (float)$respuestaVenta["total"];
...
$bloque1 = <<<EOF
  ...
  <table>
  <tr><td style="text-align:center">PROFORMA</td></tr>
    <tr>
...
$proform = new ImprimirProformaVenta();
$proform -> codigo = $_GET["codigo"];
$proform -> traerProformaVenta();
